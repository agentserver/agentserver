...
// WSTokenClient fetches the workspace's persistent proxy
...
// NewWSTokenClient constructs a client against agentserver's
...
func NewWSTokenClient(baseURL, secret string) *WSTokenClient {
	return &WSTokenClient{
...
func (c *WSTokenClient) GetOrCreate(ctx context.Context, workspaceID string) (string, error) {
	if workspaceID == "" {
