module github.com/agentserver/agentserver/v2/providers/tae
...
require (
	code.byted.org/inf/bytedai-go v1.1.63
	code.byted.org/paas/cloud-sdk-go v0.0.312
	github.com/agentserver/agentserver/v2 v2.0.0
	golang.org/x/net v0.50.0
)

require (
	code.byted.org/aiops/apm_vendor_byted v0.0.37 // indirect
	...
	code.byted.org/gopkg/env v1.7.20 // indirect
	...
	code.byted.org/kite/kitex v1.18.3 // indirect
	code.byted.org/kite/kitex/pkg/protocol/bthrift v0.0.0-20250227061731-335e4ecd258f // indirect
	...
	code.byted.org/middleware/hertz v1.14.1 // indirect
	...
	code.byted.org/tiktok/region_lib v0.11.7 // indirect
	...
	github.com/cloudwego/dynamicgo v0.9.1 // indirect; Go 1.26 link-compatible floor for cloud-sdk-go/region_lib
...
replace github.com/agentserver/agentserver/v2 => ../..
