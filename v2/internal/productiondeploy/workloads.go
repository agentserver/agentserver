...
func renderHydraDeployment(context renderContext) kubeObject {
	...
	container := kubeObject{
		...
		"env": []any{
			...
			valueEnvironment("URLS_LOGIN", "https://"+document.Ingress.FrontendHostname+"/auth/hydra/login"),
			valueEnvironment("URLS_CONSENT", "https://"+document.Ingress.FrontendHostname+"/auth/hydra/consent"),
