...
WHERE table_schema = $1 AND table_type = 'BASE TABLE'`, schema)
	...
	wantConstraints := map[string]bool{
		...
		"sessions_working_directory_bounded":                      false,
		"sessions_working_directory_version_positive":             false,
		"sessions_working_environment_pair":                       false,
		"run_launch_states_workspace_binding_pair":                false,
		"run_launch_states_workspace_root_sha256_exact":           false,
